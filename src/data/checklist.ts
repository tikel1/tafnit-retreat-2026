...
export const checklist: ChecklistItem[] = [
  ...
  {
    id: "evening",
    text: "לבוש סמארט-קז'ואל לערב",
    detail: "לערב החגיגי וההופעה — חולצה מכופתרת, שמלה יפה או כל לבוש חגיגי וקליל אחר.",
  },
  {
    id: "comfy",
  ...
  },
  {
    id: "phone",
    text: "מטען לטלפון",
    detail: "כדי שתוכלו לצלם בלי סוף בשייט ובספא – מומלץ להביא גם מטען נייד (Powerbank).",
  },
  {
    id: "meds",
  ...
  },
  {
    id: "good-mood",
    text: "מצב רוח טוב",
    detail: "באמת! דאגנו לכם להכל מאלף ועד תיו, כל מה שנשאר לכם זה להגיע וליהנות.",
  },
];
